...
* feat: Add truth output by @HCookie in https://github.com/ecmwf/anemoi-inference/pull/144
* feat(retrieve): Create runner from config by @gmertes in https://github.com/ecmwf/anemoi-inference/pull/146
### Other Changes 🔗
* fix: Update output: printer to avoid range(a, b, 0) by @Kakalinn in https://github.com/ecmwf/anemoi-inference/pull/138
* chore: synced file(s) with ecmwf-actions/reusable-workflows by @DeployDuck in https://github.com/ecmwf/anemoi-inference/pull/145
