...
class NetCDFOutput(Output):
    ...
    def _create_field_var(self, name: str) -> Variable:
        ...
        # Set metadata based attrs
        var.setncatts(attrs)

        # Set output based attrs
    ...
    def open(self, state: State) -> None:
        ...
        with LOCK:
            ...
            # TODO: this is too specific? Do we need to handle different heights?
    ...
    def write_step(self, state: State) -> None:
        ...
        for name, value in state["fields"].items():
            with LOCK:
                ...
                LOG.info(f"Writing {name}, {self.n}, {field.shape}")
