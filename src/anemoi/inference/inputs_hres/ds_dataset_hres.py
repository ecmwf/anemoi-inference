...
class DatasetInput(Input):
    ...
    def __init__(self, context, args, kwargs):
        ...
        self.kwargs["dataset"] = self.kwargs["dataset"]["x"]["zip"][1]
...
@input_hres_registry.register("dataset")
...
@input_hres_registry.register("test")
...
@input_hres_registry.register("validation")
...
@input_hres_registry.register("training")
